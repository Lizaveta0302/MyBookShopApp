    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href=/books/' + book.id + '>' + '       <img src="' + book.image + '">\n' + '</a>' +
                    (book.discount ? '<div class="Card-sale">' + (book.discount * 100).toFixed(0) + '% скидка</div>' : '') +
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED') {
                            Login().postData('/cart/changeBookStatus/archive', {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus/rate', {
            ...
            return {
                init: function () {
                    $('.Transactions-get').on('click', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        $this.data('transactionoffset', $this.data('transactionoffset') + $this.data('transactionlimit'))
                        console.log($this.data('transactionoffset'))
                        getData('/profile/transactions', {
